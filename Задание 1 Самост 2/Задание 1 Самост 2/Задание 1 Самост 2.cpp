...
void IloveTRPO()
{
    cout << "I love TRPO, It is the best in the world ,DO NOT put 7,pleaseeeee :)";
}
int main()
{
    cout << "Select task" << endl;
    cout << "1) First task" << endl;
    cout << "2) First task (additional)" << endl;
    cout << "3) Second task" << endl;
    cout << "4) Third task" << endl;
    cout << "5) Fourth task" << endl;
    cout << "6) Fifth task" << endl;
     int f;
    cin>>f;
    ...
    switch (f)
    {
        ...
        case 2:IloveTRPO(); break;
        case 3:LessThanDifferencePrevious(); break;
        case 4:LengthLongestSequence(); break;
        case 5:MatrixTranspose(); break;
        case 6:SetOfPoints(); break;
    }
